...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    //******************************************************************
    public static final int KEYCODE_BONOVO_UPDATETIME       = 320;

    public static final int KEYCODE_BONOVO_UPDATEBRIGHTNESS = 321;

    public static final int KEYCODE_BONOVO_SHUTDOWN         = 322;

    public static final int KEYCODE_BONOVO_UPDATEVOLUME      = 323;
	public static final int KEYCODE_BONOVO_UPDATESYSVOL      = 324;
    
    public static final int KEYCODE_BONOVO_VOLUME_ADD        = 325;
    public static final int KEYCODE_BONOVO_VOLUME_SUB        = 326;
    public static final int KEYCODE_BONOVO_SLEEP             = 327;
    public static final int KEYCODE_BONOVO_WAKEUP            = 328;
    public static final int KEYCODE_BONOVO_NAVI              = 329;
    public static final int KEYCODE_BONOVO_SYSTEM_MUTE       = 330;
    public static final int KEYCODE_BONOVO_CUSTOM_IR_BUTTON  = 331;
    public static final int KEYCODE_BONOVO_EQ                = 332;
    public static final int KEYCODE_BONOVO_DVD               = 333;
    public static final int KEYCODE_BONOVO_3G                = 334;
    public static final int KEYCODE_BONOVO_RECODER           = 335;
    public static final int KEYCODE_BONOVO_CMMB_TV           = 336;
    public static final int KEYCODE_BONOVO_CMMB_RADIO        = 337;
    public static final int KEYCODE_BONOVO_CAMERA            = 338;
    public static final int KEYCODE_BONOVO_BT                = 339;
    public static final int KEYCODE_BONOVO_BT_ANSWER         = 340;
    public static final int KEYCODE_BONOVO_BT_HANG_UP        = 341;
    public static final int KEYCODE_BONOVO_BT_ANSWER_HANG    = 342;
    public static final int KEYCODE_BONOVO_BT_SWITCH_AUDIO   = 343;
    public static final int KEYCODE_BONOVO_RADIO             = 344;
    public static final int KEYCODE_BONOVO_RADIO_TURNUP      = 345;
    public static final int KEYCODE_BONOVO_RADIO_TURNDOWN    = 346;
    public static final int KEYCODE_BONOVO_SWITCH_FMAM       = 347;
    public static final int KEYCODE_BONOVO_LIGHTSTATE        = 348;
	//*-----------------------------------------------------------------
    private static final int LAST_KEYCODE           = KEYCODE_BONOVO_LIGHTSTATE;
    ...
    private static void populateKeycodeSymbolicNames() {
        ...
        //* add by bonovo zbiao for android box
        //******************************************************************
        names.append(KEYCODE_BONOVO_UPDATETIME, "KEYCODE_BONOVO_UPDATETIME");
		names.append(KEYCODE_BONOVO_UPDATEBRIGHTNESS,"KEYCODE_BONOVO_UPDATEBRIGHTNESS");
		names.append(KEYCODE_BONOVO_SHUTDOWN,"KEYCODE_BONOVO_SHUTDOWN");
		names.append(KEYCODE_BONOVO_UPDATEVOLUME,"KEYCODE_BONOVO_UPDATEVOLUME");
		names.append(KEYCODE_BONOVO_UPDATESYSVOL,"KEYCODE_BONOVO_UPDATESYSVOL");
        names.append(KEYCODE_BONOVO_VOLUME_ADD,"KEYCODE_BONOVO_VOLUME_ADD");
        names.append(KEYCODE_BONOVO_VOLUME_SUB,"KEYCODE_BONOVO_VOLUME_SUB");
        names.append(KEYCODE_BONOVO_SLEEP,"KEYCODE_BONOVO_SLEEP");
        names.append(KEYCODE_BONOVO_WAKEUP,"KEYCODE_BONOVO_WAKEUP");
        names.append(KEYCODE_BONOVO_NAVI,"KEYCODE_BONOVO_NAVI");
        names.append(KEYCODE_BONOVO_SYSTEM_MUTE,"KEYCODE_BONOVO_SYSTEM_MUTE");
        names.append(KEYCODE_BONOVO_CUSTOM_IR_BUTTON,"KEYCODE_BONOVO_CUSTOM_IR_BUTTON");
        names.append(KEYCODE_BONOVO_EQ,"KEYCODE_BONOVO_EQ");
        names.append(KEYCODE_BONOVO_DVD,"KEYCODE_BONOVO_DVD");
        names.append(KEYCODE_BONOVO_3G,"KEYCODE_BONOVO_3G");
        names.append(KEYCODE_BONOVO_RECODER,"KEYCODE_BONOVO_RECODER");
        names.append(KEYCODE_BONOVO_CMMB_TV,"KEYCODE_BONOVO_CMMB_TV");
        names.append(KEYCODE_BONOVO_CMMB_RADIO,"KEYCODE_BONOVO_CMMB_RADIO");
        names.append(KEYCODE_BONOVO_CAMERA,"KEYCODE_BONOVO_CAMERA");
        names.append(KEYCODE_BONOVO_BT,"KEYCODE_BONOVO_BT");
        names.append(KEYCODE_BONOVO_BT_ANSWER,"KEYCODE_BONOVO_BT_ANSWER");
        ...
        names.append(KEYCODE_BONOVO_SWITCH_FMAM,"KEYCODE_BONOVO_SWITCH_FMAM");
        //******************************************************************
    };
