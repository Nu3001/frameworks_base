...
class ServerThread {
    ...
    public void initAndLoop() {
        ...
        try {
            ...
            canbus = new CanBusService(context);
            ServiceManager.addService("canbus", canbus);
        ...
        final CanBusService canbusF = canbus;
        ...
        ActivityManagerService.self().systemReady(new Runnable() {
            public void run() {
                ...
                try {
                 ...
                 try {
                    if (canbusF != null) canbusF.systemReady();
                } catch (Throwable e) {
                    reportWtf("making Can Bus Service ready", e);
                }
               try {
